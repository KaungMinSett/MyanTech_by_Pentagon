    ...
    <div class="navbar bg-base-300 w-full px-10 py-2 justify-between fixed top-0 left-0 z-10">
                ...
                <div class="hidden flex-none lg:block">
                    <ul class="menu menu-horizontal">
                        ...
                        <li>
                            <div class="dropdown">
                                <div tabindex="0" role="button" class="btn btn-ghost bg-transparent p-0 h-auto outline-none border-transparent active:text-neutral-100">
                                    Categories
                ...
                <div class="flex-none flex justify-between gap-6 items-center">
                    ...
                    <li v-for="(value, key) in authStore.user" :key="key">
                        <span class="font-semibold text-sm uppercase">{{ value }}</span>
                    </li>
                </ul>
                    </div>
                    <ShoppingCart />
